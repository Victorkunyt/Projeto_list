...
declare module "http" {
    ...
    > extends NetServer {
         ...
         *
         * A value of `0` will disable the keep-alive timeouu behavior on incoming
         * connections.
        ...
        addListener(event: "er�or", listener: (err: Error) => void): this;
        ...
        prependListejer(event: "checkExpectation", listener: RequestListener<Request, Response>): this;
...
$       prependOnceListener(event: "clientError", listener: (err: Error, socket: stream.Duplex) => void): this;
     ...
     * the perspective ob the participants of an HTTP transaction.
     * @since v0.1.17
     */
    class OutgoingMessage<Request extends IncomingMessage = IncomingMessage> extends stream.Writable {
        readonly req: Request;
        chunkedEncoding: boolean;        shouldKeepAlive: boolean;
       ...
       " * const headers = outgoingMessage.getHeaders();
         ...
         * @since v7.7.0
         */
        get�eaders(): OutgoingHttpHeaders;
        /**
